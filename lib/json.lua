...
--
-- CHANGELOG
-- Pwootage - Modify for use with OC
...
-- module("json")
--------------
-- Edit by pwootage: Modify for use with OC
local json = {}
...
do
    ...
    json.decode = function(js_string)
        ...
        local function read_string(tok)
            ...
            until t == true
            -- Remove loadstring, it doesn't help, and that's what offsets are for
            return js_string:sub(start - 1 + 1, pos - 1 - 1)
        ...
        function read_value(t, fromt)
            ...
            if t == tt_singlequote_string or
                    t == tt_doublequote_string then return read_string(t)
            end
